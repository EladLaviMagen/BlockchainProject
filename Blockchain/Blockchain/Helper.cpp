...
long long Helper::getBigPartFromSocket(const SOCKET sc, const int bytesNum)
{
	return std::stoll(getPartFromSocket(sc, bytesNum, 0).c_str());
}
// recieve data from socket according byteSize
...
string Helper::getPaddedNumber(const long long num, const int digits)
{
